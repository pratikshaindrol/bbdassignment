...
public static void main(String[] args) {
		...
		List<WebElement> allLinks = driver.findElements(By.tagName("a"));
		 ...
		 driver.findElement(By.cssSelector("a[aria-label='IPL']")).click();
		 driver.navigate().back();
		 driver.findElement(By.xpath("//a[@aria-label='News']//img[@class='s-img']")).click();
		 driver.navigate().back();
		 driver.findElement( By.xpath("/html[1]/body[1]/div[2]/div[1]/ol[1]/li[1]/div[1]/div[1]/ul[1]/li[5]/div[1]/div[1]/a[1]")).click();
		 driver.navigate().back();
		 driver.close();
	   }
	      }
